                ...
                <div class="col-md-9">
                    ...
                    <div class="box" id="text-page">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="../resources/assets/img/detailsquare.jpg" class="../resources/assets/img-circle img-responsive" alt="">
                                </p>
                                <p class="text-center">circle</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="../resources/assets/img/detailsquare.jpg" class="../resources/assets/img-thumbnail  img-responsive" alt="">
                                </p>
                                <p class="text-center">thumbnail</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="../resources/assets/img/detailsquare.jpg" class="../resources/assets/img-rounded img-responsive" alt="">
                                </p>
