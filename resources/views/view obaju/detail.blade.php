...
<body>
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="banner">
                                                <a href="#">
                                                    <img src="../resources/assets/img/banner.jpg" class="../resources/assets/img img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="banner">
                                                <a href="#">
                                                    <img src="../resources/assets/img/banner2.jpg" class="../resources/assets/img img-responsive" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
 ...
 _________________________________________________________ -->
                    ...
                    <div class="banner">
                        <a href="#">
                            <img src="../resources/assets/img/banner.jpg" alt="sales 2014" class="../resources/assets/img-responsive">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row" id="productMain">
                        <div class="col-sm-6">
                            <div id="mainImage">
                                <img src="../resources/assets/img/detailbig1.jpg" alt="" class="../resources/assets/img-responsive">
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row" id="thumbs">
                                <div class="col-xs-4">
                                    <a href="../resources/assets/img/detailbig1.jpg" class="thumb">
                                        <img src="../resources/assets/img/detailsquare.jpg" alt="" class="../resources/assets/img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="../resources/assets/img/detailbig2.jpg" class="thumb">
                                        <img src="../resources/assets/img/detailsquare2.jpg" alt="" class="../resources/assets/img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="../resources/assets/img/detailbig3.jpg" class="thumb">
                                        <img src="../resources/assets/img/detailsquare3.jpg" alt="" class="../resources/assets/img-responsive">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="product same-height">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="{{ url('detail') }}">
                                                <img src="../resources/assets/img/product2.jpg" alt="" class="../resources/assets/img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="{{ url('detail') }}">
                                                <img src="../resources/assets/img/product2_2.jpg" alt="" class="../resources/assets/img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product same-height">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="{{ url('detail') }}">
                                                <img src="../resources/assets/img/product1.jpg" alt="" class="../resources/assets/img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="{{ url('detail') }}">
                                                <img src="../resources/assets/img/product1_2.jpg" alt="" class="../resources/assets/img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product same-height">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="{{ url('detail') }}">
                                                <img src="../resources/assets/img/product3.jpg" alt="" class="../resources/assets/img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="{{ url('detail') }}">
                                                <img src="../resources/assets/img/product3_2.jpg" alt="" class="../resources/assets/img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
